<template>
  <footer class="footer">
    <!-- BEGIN Button -->
    <button class="footer__btn" @click="openModal('Apple')">
      <svg class="icon icon-apple" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <!-- BEGIN Button -->
    <button class="footer__btn" @click="openModal('Android')">
      <svg class="icon icon-adnroid" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
